...
SC_MODULE(test_ringbuf)
{
        ...
        actual("actual")
    {
        ...
        sig1.observe_foreign_signal("test_ringbuf.ring_INST.block2.sig1");
        sig2.observe_foreign_signal("/test_ringbuf/ring_INST/block2/sig2");
        sig3.observe_foreign_signal("/test_ringbuf/ring_INST/block2/sig3");
        sig4.observe_foreign_signal("test_ringbuf.ring_INST.block2.sig4[0]");
    }
