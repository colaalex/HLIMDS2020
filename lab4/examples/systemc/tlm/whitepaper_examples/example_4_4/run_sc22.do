...
sccom -sc22 -suppress 6102 -I../../utils -I../basic_protocol -I../pipelined_protocol -I../user -g test.cc
sccom -sc22 -suppress 6102 -I../../utils -I../basic_protocol -I../pipelined_protocol -I../user -g pipelined_master.cc
sccom -sc22 -suppress 6102 -I../../utils -I../basic_protocol -I../pipelined_protocol -I../user -g pipelined_slave.cc
