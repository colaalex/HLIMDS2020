...
void test_ringbuf::print_sig1()
{
    cout << "sig1=" << sig1.read() << endl << flush;;
}


void test_ringbuf::print_sig2()
{
    cout << "sig2=" << sig2.read() << endl << flush;;
}


void test_ringbuf::print_sig3()
{
    cout << "sig3=" << sig3.read() << endl << flush;;
}


void test_ringbuf::print_sig4()
{
    cout << "sig4(0)=" << sig4.read() << endl << flush;;
}
