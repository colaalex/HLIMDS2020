...
SC_MODULE(test_ringbuf)
{
        ...
        actual("actual")
    {
        ...
        sig1.control_foreign_signal("/test_ringbuf/ring_INST/block1_INST/sig1");
        sig2.control_foreign_signal("/test_ringbuf/ring_INST/block1_INST/sig2");
        sig3.control_foreign_signal("/test_ringbuf/ring_INST/block1_INST/sig3");
        sig4.control_foreign_signal("/test_ringbuf/ring_INST/block1_INST/sig4(1)");
    }
